...
```
curl -sSL https://nightly.link/Orbitale/Rymfony/workflows/Build.yaml/main/rymfony.ubuntu.zip -o rymfony.zip && unzip rymfony.zip && sudo mv rymfony /usr/bin/rymfony && sudo chmod a+x /usr/bin/rymfony
```
...
```
curl -sSL https://nightly.link/Orbitale/Rymfony/workflows/Build.yaml/main/rymfony.macOS.zip -o rymfony.zip && unzip rymfony.zip && sudo mv rymfony /usr/bin/rymfony && sudo chmod a+x /usr/bin/rymfony
```
